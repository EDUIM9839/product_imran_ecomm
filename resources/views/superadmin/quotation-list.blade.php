							...
							<ul>
								...
								<li class="submenu">
									...
									<ul>
										...
										<li class="active"><a href="quotation-list.html"><span>Quotation</span></a></li>
										<li class="submenu">
										...
										<div class="row">
											...
											<div class="col-lg-2 col-sm-2 col-2 p-0">
												<div class="add-icon tab">
													<a class="bg-dark text-white p-2 rounded"><img src="assets/img/icons/plus1.svg" alt="img">
													</a>
												</div>
											</div>
										</div>
			...
			<div class="modal-dialog edit-sales-modal">
				<div class="modal-content">
					<div class="page-header p-4">
						<div class="add-item new-sale-items d-flex align-items-center justify-content-between w-100 me-0">
							<div class="page-title">
					...
					<form action="https://dreamspos.dreamstechnologies.com/html/template/quotation-list.html">
								...
								<div class="row">
										...
										<div class="mb-3">
											...
											<div class="row">
												...
												<div class="col-lg-2 col-sm-2 col-2 ps-0">
													<div class="add-icon">
														<span class="bg-dark text-white p-2 rounded"><i data-feather="plus-circle" class="plus"></i></span>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-lg-4 col-sm-6 col-12">
										<div class="mb-3">
											...
											<input type="text" class="form-control" value="010203">
										</div>
									</div>
					...
					<div class="modal-body p-0">
						<div class="success-wrap text-center">
							<form action="https://dreamspos.dreamstechnologies.com/html/template/quotation-list.html">
								...
								<h3 class="mb-2">Delete Quotation</h3>
								<p class="fs-16 mb-3">Are you sure you want to delete quotation?</p>

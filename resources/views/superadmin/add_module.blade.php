...
@section('mains')
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        {{-- <button data-bs-toggle="modal" data-bs-target="#roleModal">Add Role</button> --}}
                        <a href="" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#add-module"><i class="ti ti-circle-plus me-1"></i>Add Module</a>
                    </div>
                </div>
                        ...
                        {{-- <div
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-3">
                                    ...
                                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1 status-filter"
                                            data-status="1">Active</a></li>
                                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1 status-filter"
                                            data-status="0">Inactive</a></li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="form-check form-check-md">
                                                ...
                                                <button type="button" class="btn btn-danger mb-3" id="bulkDeleteBtn"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="createModuleBtn" class="btn btn-primary">Create Module</button>
                </div>
    ...
    <!-- Edit Module Modal -->
    <div class="modal fade" id="edit-module">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Module Name</label>
                        <input type="text" id="edit_module_name" name="edit_module_name" class="form-control"
                            required>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                        <label class="form-label">Status</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary me-2" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" id="updateModuleBtn" class="btn btn-primary">Update Module</button>
                </div>
    ...
    <div class="modal fade" id="delete-module">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                @csrf
                <div class="modal-body">
                    <input type="hidden" id="delete_module_id">
                    <p>Are you sure you want to delete <strong id="delete_module_name"></strong>?</p>
                </div>
    ...
    <script>
        ...
        $('.role-checkbox').on('change', function() {
            let allChecked = $('.role-checkbox').length === $('.role-checkbox:checked').length;
            $('#select-all').prop('checked', allChecked);
            toggleBulkDeleteBtn();
        });

        function toggleBulkDeleteBtn() {
            let anyChecked = $('.role-checkbox:checked').length > 0;
        ...
        $('#bulkDeleteBtn').on('click', function() {
            ...
            if (!confirm('Are you sure you want to delete selected Module?')) return;

            $.ajax({
                url: "{{ route('modul.bulk-delete') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
    ...
    <script>
        $(document).on('click', '.status-filter', function() {
            ...
            $.ajax({
                url: "{{ route('roles.filter') }}",
                type: "GET",
                data: {
                    status: status
                },
                success: function(response) {
                    $('#rolesTableBody').html(response.html);
                },
                error: function() {
                    alert('Failed to filter roles.');
                }
            });
        });
    </script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#createModuleBtn').on('click', function() {
    ...
    <script>
        $(document).on('click', '.deleteModuleBtn', function() {
            ...
            $('#delete_module_name').text(name);

            $('#delete-module').modal('show');
        });
        $('#confirmDeleteBtn').on('click', function() {
            var id = $('#delete_module_id').val();

							...
							<li class="submenu">
								...
								<ul>
									...
									<li class="submenu">
										...
										<ul>
											<li><a href="expense-list.html" class="active">Expenses</a></li>
								...
								<form action="https://dreamspos.dreamstechnologies.com/html/template/expense-list.html">
									<div class="modal-body">
										<div class="row">
											<div class="col-12">
												<div class="mb-3">
													<label class="form-label">Expense<span class="text-danger ms-1">*</span></label>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-12">
									<div class="mb-3">
										<label class="form-label">Expense<span class="text-danger ms-1">*</span></label>
										<input type="text" class="form-control" value="Electricity Payment">
									</div>
								</div>

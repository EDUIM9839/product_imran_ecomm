...
@section('mains')
        ...
        <div class="sidebar sidebar-horizontal" id="horizontal-menu">
            <div id="sidebar-menu-3" class="sidebar-menu">
                <div class="main-menu">
                    <ul class="nav-menu">
                        <li class="submenu">
                            <a href="index.html"><i class="ti ti-layout-grid fs-16 me-2"></i><span> Main Menu</span> <span
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="active"><span>User Management</span><span
                                            class="menu-arrow"></span></a>
                                    <ul>
                                        <li><a href="users.html"><span>Users</span></a></li>
                                        <li><a href="roles-permissions.html" class="active"><span>Roles &
                ...
                <div class="twocol-mini">
                    <div class="sidebar-left slimscroll">
                        <div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
                            ...
                            <a href="#" class="nav-link active" title="Pages" data-bs-toggle="tab"
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pages">
                                <ul>
                                    ...
                                    <li><a href="faq.html"><span>FAQ</span></a></li>
                                    <li><a href="users.html"><span>Users</span></a></li>
                                    <li class="active"><a href="roles-permissions.html"><span>Roles &
                                                Permissions</span></a></li>
                                    <li><a href="delete-account.html"><span>Delete Account Request</span></a></li>
                                    <li><a href="profile.html"><span>Profile</span></a></li>
                                    <li class="submenu">
            ...
            <div class="content">
                <div class="page-header">
                    ...
                    <ul class="table-top-head">
                        ...
                        <li>
                            <div class="page-btn">
                                <a href="{{ route('roles-permissions') }}" class="btn btn-primary"
                                    style="width: 100%;"><i data-feather="arrow-left" class="me-2"></i> Back to
                                    Roles</a>
                            </div>
                        </li>
                    </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-check-md">
                                                    <input type="checkbox"
                                                        name="permissions[{{ $module->id }}][allow_all]"
                                                        class="form-check-input allow-all-checkbox"
                                                        data-row-id="{{ $module->id }}"
														 data-role-id="{{ $roleId }}"
                                                        {{ $perm && $perm->allow_all ? 'checked' : '' }}>
                                                </div>
                                            </td>

                                            <!-- Individual Permissions -->
                                            @foreach (['read', 'write', 'create', 'delete', 'import', 'export'] as $permType)
                                                <td>
                                                    <div class="form-check form-check-md">
                                                        <input type="checkbox"
    ...
    // "Allow All" Checkbox Toggle
    $(document).on('change', '.allow-all-checkbox', function() {
        var rowId = $(this).data('row-id');
        var role_id = $(this).data('role-id');
        var isChecked = $(this).is(':checked');
		console.log(role_id);

        // Toggle all individual permissions in the same row
        $('input.permission-checkbox[data-row-id="' + rowId + '"]').prop('checked', isChecked);

        // Save Immediately
        savePermissions(rowId,role_id);
    });
    ...
    $(document).on('change', '.permission-checkbox', function() {
        ...
        // If ALL are checked, check "Allow All" else uncheck it
        var allChecked = $('input.permission-checkbox[data-row-id="' + rowId + '"]').length ===
                         $('input.permission-checkbox[data-row-id="' + rowId + '"]:checked').length;

        $('input.allow-all-checkbox[data-row-id="' + rowId + '"]').prop('checked', allChecked);
    ...
    // AJAX Save Function
    function savePermissions(rowId,role_id) {
        var permissions = {};

        // Allow All
        permissions['allow_all'] = $('input.allow-all-checkbox[data-row-id="' + rowId + '"]').is(':checked') ? 1 : 0;

        // Individual Permissions
        $('input.permission-checkbox[data-row-id="' + rowId + '"]').each(function() {
            var type = $(this).data('type');
            permissions[type] = $(this).is(':checked') ? 1 : 0;
        });

        // AJAX POST to Update Permissions
        $.ajax({
            url: "{{ route('permissions.update') }}",  // Update this route as needed
            method: "POST",
            data: {
                module_id: rowId,
                role_id: role_id,
            ...
            success: function(response) {
                console.log('Permissions updated successfully for module ID ' + rowId);
            },
            error: function(xhr) {

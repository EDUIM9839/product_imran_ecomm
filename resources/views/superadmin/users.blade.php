...
@section('mains')
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="active"><span>User Management</span><span
                                            class="menu-arrow"></span></a>
                                    <ul>
                                        <li><a href="users.html" class="active"><span>Users</span></a></li>
                ...
                <div class="twocol-mini">
                    <div class="sidebar-left slimscroll">
                        <div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
                            ...
                            <a href="#" class="nav-link active" title="Stock" data-bs-toggle="tab"
                ...
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#add-user"><i class="ti ti-circle-plus me-1"></i>Add User</a>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                        <img src="{{ $user->profile_image ? asset('uploads/users/' . $user->profile_image) : asset('default-profile.png') }}"
                                                            alt="product">
                                            ...
                                            <td><a href="" class="__cf_email__">{{ $user->email }}</a></td>
                                            ...
                                            <td class="action-table-data">
                                                <div class="edit-delete-action">
                                                    ...
                                                    <a data-bs-toggle="modal"
                                                        ...
                                                        class="p-2 mb-0" href="javascript:void(0);">
                                                                                ...
                                                                                <div class="profile-pic-upload mb-2">
                                                                                    <div class="profile-pic">
                                                                                        <img id="preview-image-{{ $user->id }}"
                                                                                            src="{{ $user->profile_image ? asset('uploads/users/' . $user->profile_image) : asset('default-profile.png') }}"
                                                                                            alt="Preview"
                                                                                            width="100"
                                                                                            style="display: block;" />
                                                                                        <!-- Always visible -->
                                                                                        <span
                                                                                            id="add-image-text-{{ $user->id }}"
                                                                                            style="display: none;">
                                                                                    ...
                                                                                    <div class="mb-0">
                                                                                        ...
                                                                                        <p class="fs-13 mt-2">JPEG, PNG up
                                                                                            to 2 MB</p>
                                                                                        @error('profile_image')
                                                                                            <span
                                        ...
                                        <!-- delete modal -->
                                        <div class="modal fade modal-default" id="delete-modal{{ $user->id }}">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-body p-0">
                                                        <div class="success-wrap text-center">
                                                            <form action="{{ route('users.destroy', $user->id) }}"
                                                                ...
                                                                @method('DELETE')
                                                                <div
                                                                    class="icon-success bg-danger-transparent text-danger mb-2">
                                                                    <i class="ti ti-trash"></i>
                                                                </div>
                                                                <h3 class="mb-2">Delete Role</h3>
                                                                <p class="fs-16 mb-3">Are you sure you want to delete User
                                                                    id <strong>{{ $user->user_id }}</strong>?</p>
                                                                <div
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-md btn-primary">Yes,
                                                                        Delete</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="new-employee-field">
                                            ...
                                            <div class="profile-pic-upload mb-2">
                                                <div class="profile-pic">
                                                    <img id="preview-image" src="{{ asset('default-profile.png') }}"
                                                        alt="Preview" width="100" style="display: none;" />
                                                    <span id="add-image-text"><i data-feather="plus-circle"
                                    ...
                                    <div class="col-lg-12">
                                        <div
                                            class="status-toggle modal-status d-flex justify-content-between align-items-center">
                                            <span class="status-label">Status</span>
                                            <input type="checkbox" name="status" id="user1" class="check"
                                                checked>
    ...
    <script>
        ...
        $(document).on('change', '.profile_image_input', function(event) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    $('#preview-image-' + userId).attr('src', e.target.result).show();
                    $('#add-image-text-' + userId).hide();
                };

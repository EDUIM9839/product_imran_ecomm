								...
								<li class="submenu">
									...
									<ul>
										<li class="submenu">
											...
											<ul>
												<li><a href="online-orders.html" class="active">Online Orders</a></li>
								...
								<div class="invoice-box table-height" style="max-width: 1600px;width:100%;padding: 0;font-size: 14px;line-height: 24px;color: #555;">
									<div class="row sales-details-items d-flex">
										<div class="col-md-4 details-item">
											...
											<p class="mb-0">Email<span><a href="https://dreamspos.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="117270637d7467707f62232520517469707c617d743f727e7c">[email&#160;protected]</a></span></p>
										...
										<div class="col-md-4 details-item">
											...
											<p class="mb-0">Email<span><a href="https://dreamspos.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f190959c989fb19489909c819d94df929e9c">[email&#160;protected]</a></span></p>
										...
										<div class="col-lg-6 ms-auto">
											<div class="total-order w-100 max-widthauto m-auto mb-4">
												<ul  class="border-1 rounded-1">
													...
													<li class="border-bottom">
														<h4 class="border-end">Paid</h4>
														<h5>$ 5200.00</h5>
													</li>
													<li class="border-bottom">
														<h4 class="border-end">Due</h4>
														<h5>$ 0.00</h5>
													</li>
												</ul>
											</div>
													...
													<tr>
														...
														<td>
															<div class="product-quantity bg-gray-transparent border-0">
																...
																<input type="text" class="quntity-input form-control bg-transparent" value="2">
										...
										<div class="row">
											...
											<div class="col-lg-4 col-sm-6 col-12">
												<div class="mb-3">
													...
													<div class="input-groupicon calender-input">
														<i data-feather="calendar" class="info-img"></i>
														<input type="text" class="datetimepicker form-control" placeholder="19 jan 2023">
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-sm-6 col-12">

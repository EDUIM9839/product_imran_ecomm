...
@section('mains')
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="category-list.html" class="active"><span>Category</span></a></li>
                ...
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#addCategoryModal"><i class="ti ti-circle-plus me-1"></i>Add Category</a>
                    </div>
                </div>
                <!-- /product list -->
                <div class="card">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-0">
                        <div class="status-toggle modal-status d-flex justify-content-between align-items-center">
                            ...
                            <input type="checkbox" id="categoryStatus" class="check" checked>
                            <label for="categoryStatus" class="checktoggle"></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="page-wrapper-new p-0">
                    <div class="content p-5 px-3 text-center">
                        ...
                        <div class="modal-footer-btn mt-3 d-flex justify-content-center">
                            ...
                            <button type="button" class="btn btn-primary fs-13 fw-medium p-2 px-3"
    ...
    <script>
        $(document).ready(function() {
            ...
            // Save Button Click (Add/Update)
            $('#saveBtn').click(function() {
                var id = $('#categoryId').val();
                var url = id ? "{{ route('categories.update') }}" : "{{ route('categories.store') }}";
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        status: $('#categoryStatus').is(':checked') ? 'Active' : 'Inactive'
                    },
            ...
            $(document).on('click', '.edit-category', function() {
                ...
                $('#categoryStatus').prop('checked', status === 'Active');

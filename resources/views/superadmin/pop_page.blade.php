...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/pos.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jun 2025 12:27:31 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
	...
	<body class="pos-page">
			...
			<div class="header pos-header">
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item time-nav">
						<span class="bg-teal text-white d-inline-flex align-items-center"><img src="assets/img/icons/clock-icon.svg" alt="img" class="me-2">09:25:32</span>
					</li>
					<!-- /Search -->
								...
								<div class="content-wrap">
									<div class="tab-wrap">
										<ul class="tabs owl-carousel pos-category5">
											...
											<li id="mobiles">
												<a href="javascript:void(0);">
													<img src="assets/img/products/pos-product-15.png" alt="Categories">
												</a>
												<h6><a href="javascript:void(0);">Mobiles</a></h6>
											</li>
											<li id="watches">
												<a href="javascript:void(0);">
													<img src="assets/img/products/pos-product-03.png" alt="Categories">
												</a>
				...
				<div class="modal-content">
					<div class="modal-body">
						...
						<div class="text-center info text-center">
							...
							<p class="mb-0">Email: <a href="https://dreamspos.dreamstechnologies.com/cdn-cgi/l/email-protection#c4a1bca5a9b4a8a184a3a9a5ada8eaa7aba9"><span class="__cf_email__" data-cfemail="f3968b929e839f96b3949e929a9fdd909c9e">[email&#160;protected]</span></a></p>
						</div>
					...
					<div class="modal-body p-0">
						<div class="success-wrap">
							...
							<div class="bg-success-transparent p-2 mb-3 br-5 border-start border-success d-flex align-items-center">
								...
								<p class="fs-13 fw-medium text-gray-9">A receipt of this transaction will be sent to the registered info@<a href="https://dreamspos.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6c0f191f180301091e2c09140d011c0009420f0301">[email&#160;protected]</a></p>
							</div>
					...
					<div class="modal-body p-0">
						<div class="success-wrap">
							...
							<div class="bg-success-transparent p-2 mb-3 br-5 border-start border-success d-flex align-items-center">
								...
								<p class="fs-13 fw-medium text-gray-9">A receipt of this transaction will be sent to the registered info@<a href="https://dreamspos.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aecddbdddac1c3cbdceecbd6cfc3dec2cb80cdc1c3">[email&#160;protected]</a></p>
							</div>
							<div class="resend-form mb-3">
								<input type="text" class="form-control" value="infocustomer@example.com">
								<button type="submit" class="btn btn-primary btn-xs">Resend Email</button>
					...
					<div class="modal-body p-0">
						<div class="calculator-wrap">
							...
							<div class="calculator-body d-flex justify-content-between">
								<div class="text-center">
									<button class="btn btn-clear" onclick="if (!window.__cfRLUnblockHandlers) return false; clr()" data-cf-modified-856c53e84058c8c25ee0e9f1-="">C</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('7')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">7</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('4')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">4</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('1')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">1</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis(',')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">,</button>
								</div>
								<div class="text-center">
									<button class="btn btn-expression" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('https://dreamspos.dreamstechnologies.com/')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">÷</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('8')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">8</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('5')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">5</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('2')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">2</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('00')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">00</button>									
								</div>
								<div class="text-center">
									<button class="btn btn-expression" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('%')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">%</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('9')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">9</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('6')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">6</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('3')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">3</button>
									<button class="btn btn-number" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('.')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">.</button>									
								</div>
								<div class="text-center">
									<button class="btn btn-clear" onclick="if (!window.__cfRLUnblockHandlers) return false; back()" data-cf-modified-856c53e84058c8c25ee0e9f1-=""><i class="ti ti-backspace"></i></button>
									<button class="btn btn-expression" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('*')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">x</button>
									<button class="btn btn-expression" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('-')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">-</button>
									<button class="btn btn-expression" onclick="if (!window.__cfRLUnblockHandlers) return false; dis('+')" data-cf-modified-856c53e84058c8c25ee0e9f1-="">+</button>
									<button class="btn btn-clear" onclick="if (!window.__cfRLUnblockHandlers) return false; solve()" data-cf-modified-856c53e84058c8c25ee0e9f1-="">=</button>									
								</div>
							</div>							
						</div>
					</div>
		...
		<!-- jQuery -->
		<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.7.1.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>

		<!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="assets/js/bootstrap.bundle.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>

		<!-- Chart JS -->
		<script src="assets/plugins/apexchart/apexcharts.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
		<script src="assets/plugins/apexchart/chart-data.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="assets/js/jquery.dataTables.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
		<script src="assets/js/dataTables.bootstrap5.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>

		<!-- Daterangepikcer JS -->
		<script src="assets/js/moment.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
		<script src="assets/plugins/daterangepicker/daterangepicker.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>

		<!-- Owl JS -->
		<script src="assets/plugins/owlcarousel/owl.carousel.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>

		<!-- Sticky-sidebar -->
		<script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
		<script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
		
		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
		<script src="assets/js/calculator.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
		<script src="assets/js/script.js" type="856c53e84058c8c25ee0e9f1-text/javascript"></script>
	
	<script src="scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="856c53e84058c8c25ee0e9f1-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"94afa79cbb703e1c","version":"2025.5.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/pos.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jun 2025 12:28:02 GMT -->
</html>
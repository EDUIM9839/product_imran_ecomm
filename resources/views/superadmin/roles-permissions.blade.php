...
@section('mains')
                ...
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        ...
                        <a href="" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#add-role"><i class="ti ti-circle-plus me-1"></i>Add Role</a>
                    </div>
                </div>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody id="rolesTableBody">
                                    @foreach ($roles as $role)
                                            ...
                                            <td>
                                                <div class="form-check form-check-md">
                                                    <input class="form-check-input role-checkbox" type="checkbox"
                                                        name="selected_roles[]" value="{{ $role->id }}">
                                                </div>
                                            </td>
                                            <td>{{ $role->name }}</td>
                                            ...
                                            <td>
                                                <div class="action-icon d-inline-flex">
                                                    <a href="{{ route('roles.permissions', $role->id) }}"
                                                        class="me-2 d-flex align-items-center p-2 border rounded"><i
                                                    ...
                                                    <a href="#" data-bs-toggle="modal"
                                                        ...
                                                        class=" d-flex align-items-center p-2 border rounded"><i
                                        ...
                                        <div class="modal fade modal-default" id="deleteRoleModal{{ $role->id }}">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-body p-0">
                                                        <div class="success-wrap text-center">
                                                            <form method="POST"
                                                                ...
                                                                <p class="fs-16 mb-3">Are you sure you want to delete role
    ...
    <script>
        $(document).on('keyup', '#roleSearchInput', function() {
            let query = $(this).val();

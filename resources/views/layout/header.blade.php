		...
		<div class="header">
			<div class="main-header">
				...
				<div class="header-left active">
					<a href="{{ route('super_admin.dashboard')}}" class="logo logo-normal">
						<img src="{{ asset('../assets/img/logo.svg') }}" alt="Img">
					</a>
					<a href="{{ route('super_admin.dashboard')}}" class="logo logo-white">
						<img src="{{ asset('../assets/img/logo-white.svg') }}" alt="Img">
					</a>
					<a href="{{ route('super_admin.dashboard')}}" class="logo-small">
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown link-nav">
						...
						<div class="dropdown-menu dropdown-xl dropdown-menu-center">
							<div class="row g-2">
								<div class="col-md-2">
									<a href="{{ route('category-list') }}" class="link-item">
								...
								<div class="col-md-2">
									<a href="{{ route('add-product') }}" class="link-item">
										<span class="link-icon">
								...
								<div class="col-md-2">
									<a href="{{ route('online-orders') }}" class="link-item">
										<span class="link-icon">
								...
								<div class="col-md-2">
									<a href="{{ route('expense-list') }}" class="link-item">
										<span class="link-icon">
								...
								<div class="col-md-2">
									<a href="{{ route('quotation-list') }}" class="link-item">
										<span class="link-icon">
								...
								<div class="col-md-2">
									<a href="{{ route('sales-returns') }}" class="link-item">
										<span class="link-icon">
								...
								<div class="col-md-2">
									<a href="{{ route('users') }}" class="link-item">
										<span class="link-icon">
								...
								<div class="col-md-2">
									<a href="{{ route('customers') }}" class="link-item">
										<span class="link-icon">
								...
								<div class="col-md-2">
									<a href="{{ route('sales-report') }}" class="link-item">
										<span class="link-icon">
					...
					<li class="nav-item pos-nav">
						<a href="{{ route('pop-page') }}" class="btn btn-dark btn-md d-inline-flex align-items-center">
						...
						<div class="dropdown-menu notifications">
							...
							<div class="noti-content">
								<ul class="notification-list">
									...
									<li class="notification-message">
										<a href="{{ route('activities')}}" class="recent-msg">
											<div class="media d-flex">
												<span class="avatar flex-shrink-0">
							...
							<div class="topnav-dropdown-footer d-flex align-items-center gap-3">
								...
								<a href="{{ route('activities')}}" class="btn btn-primary btn-md w-100">View all</a>
							</div>
						</div>
					</li>
					<!-- /Notifications -->
					...
					<li class="nav-item nav-item-box">
						<a href="{{ route('general-settings') }}"><i class="ti ti-settings"></i></a>
					</li>
					<li class="nav-item dropdown has-arrow main-drop profile-nav">
						...
						<div class="dropdown-menu menu-drop-user">
							...
							<a class="dropdown-item" href="{{ route('sales-report') }}"><i class="ti ti-file-text me-2"></i>Reports</a>
							<a class="dropdown-item" href="{{ route('general-settings') }}"><i class="ti ti-settings-2 me-2"></i>Settings</a>
							<hr class="my-2">
							<form method="POST" action="{{ route('logout') }}">
							<a class="dropdown-item logout pb-0" href="{{ route('signin') }}"><i class="ti ti-logout me-2"></i>Logout</a>
							</a>
						</div>
					</li>
				</ul>

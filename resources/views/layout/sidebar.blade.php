...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-header p-3 pb-0 pt-2">
        ...
        <div class="d-flex align-items-center justify-content-between menu-item mb-3">
            <div>
                <a href="{{ route('super_admin.dashboard') }}" class="btn btn-sm btn-icon bg-light">
            ...
            <ul>
                <li class="submenu-open">
                    ...
                    <ul>
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="{{ route('super_admin.dashboard') }}" class="active">Admin Dashboard</a>
                                </li>
                                <li><a href="{{ route('admin-dashboard') }}">Admin Dashboard 2</a></li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('roles-permissions') }}"><i
                                    class="ti ti-jump-rope fs-16 me-2"></i><span>Roles & Permissions</span></a></li>
                        <li><a href="{{ route('add-modules') }}"><i
                                    class="ti ti-jump-rope fs-16 me-2"></i><span>Add Module</span></a></li>
                    </ul>
                </li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="coming-soon.html"><i class="ti ti-send fs-16 me-2"></i><span>Coming Soon</span>
                            </a>
                        </li>
                        <li>
                            <a href="under-maintenance.html"><i
                                    class="ti ti-alert-triangle fs-16 me-2"></i><span>Under Maintenance</span> </a>
                        </li>
                    </ul>
                </li>
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <i class="ti ti-logout fs-16 me-2"></i><button type="submit"
